...
login_admin_schema.pre('save',async function(next){
...
login_admin_schema.statics.login=async function(email,password)
{
...
let login_signup_admin_model=mongoose.model('login_signup_admin',login_admin_schema);
module.exports=login_signup_admin_model;