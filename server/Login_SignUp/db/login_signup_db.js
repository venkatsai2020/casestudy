...
let login_signup_schema=schema({
    email:{
        type: String,
...
login_signup_schema.pre('save',async function(next){
...
login_signup_schema.statics.login=async function(email,password)
{
...
let login_signup_model=mongoose.model('login_signup',login_signup_schema);
